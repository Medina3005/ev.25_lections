...
# except IndexError:
#     raise ValueError('Invalid id for user! User with this id does noe exists!')

# if user['role'] == roles[0]:
#     choice = input('Vvedite chto izmenit\':')
#     product[choice] = input('Vvedite novoe znachenie:')
# else:
...
#дан список внутри которого списка из трех чисел.нужно найти максимальную сумму среди всех списков.
...
#напишите функцию которая будет получать строку и она должна перевернуть строку 
