...
# if <condition>:
#     <body if> # сработает если в вырвжении if придет True
...
# email = input('Enter ')
# passsword1 = input('Enter the password:')
...
#     print('You can enter the system Mr/Mrs{user}!')

# else:
#     print('Sorry, you can couldn\'t enter!')


# Операторы идентификации  
# in -> проверяет наличие элемента ынутри кakого либо итерируемого обьекта (строки списки и тд)
# is -> сравнивает ячейки памяти двух обьектов 
# # == -> сравнивает по значению
# is not ->отрицательное ячейки памяти 
